...
(function () {
     ...
     * @private
     */
    function _sendMessage(msgType, friendUID, msgContent, fn_callback, fingerPrint, isIMCheck=true){
        var sucess = false;
        var msgBody = null;

        if(isIMCheck && !RBChatChattingContentPaneUI.send4IMCheck()){
            //
        }
        else if(!friendUID){
            //alert('消息接收者不能为空！');
...
(function () {
     ...
     * @private
     */
    function _sendGroupMessage(msgType, toGid, msgContent, fn_callback, fingerPrint){
