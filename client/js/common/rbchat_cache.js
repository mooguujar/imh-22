...
var AlarmsProvider = (function () {
    ...
    Cache3.prototype.refreshHistoryChattingAlarmsAsync = function (fn_callback_for_success) {
        ...
        RBChatRestHelper.queryAlarmsHistoryFromServer(localUserUid, startTime
            , function (returnValue){
     ...
     * @returns {{}}
     */
    Cache3.prototype.createAGroupChatMsgAlarm = function(messageContentType, messageContent, toGname, toGid, fromUserNickName, time){

        // 新的AlarmMessageDto对象
        var amd = {};
        amd.alarmMessageType = AlarmMessageType.groupChatMessage;
        amd.title = toGname;
...
var SingleChattingCache = (function () {
    ...
    Cache4.prototype.loadOfflineMessagesAsync = function(from_user_uid, fn_callback_for_success){
        ...
        RBChatRestHelper.submitGetOfflineChatMessagesToServer(localUserUid, from_user_uid
            , function (returnValue){
