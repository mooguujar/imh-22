...
/**
 * IM界面右边详情显示区域的UI封装模块（是一个windows范围内的全局对象）。
 */
var RBChatRightDetailUI = (function () {
    ...
    UIModule6.prototype.showTabsForSelectedAlarm = function(alarmMessageType, uid){
        ...
        // 群聊天消息时
            ...
            // tab点击事件
            $('#im-panel-header-righttabs-group-baseinfo').click(function(){
                // 加载并显示群基本信息
                that.loadGroupBaseInfoFromServer(uid);
            });

            // 默认显示第一个tab的内容
            $('#im-panel-header-righttabs-group-baseinfo').click();//this.showGroupBaseInfo(GroupsProvider.getGroupInfoByGid(uid));
        }
     ...
     */
    UIModule6.prototype.showSingerUserBaseInfo = function(ree){
        ...
        var html =
            ...
            '       <a target=\"_blank\" href=\"'+RBChatUtils.getUserAvatarDownloadURL2(uid, true)+'\">'+
            '           <img onerror=\'javascript:userActttnotFound($(this))\' id=\"im-panel-main-rightdetail-content-user-avatar\" src=\"'+RBChatUtils.getUserAvatarDownloadURL(uid, true)+'\">'+
            '       </a>'+
            '   </div>'+
            '   <div class=\"info\">'+
            '       <h4 id=\"im-panel-main-rightdetail-content-user-showname\" title=\"'+RBChatUtils.getNickNameWithRemark(ree)+'\">'+nickname+'</h4>'+
            '       <span style=\'cursor: pointer\' id=\"im-panel-main-rightdetail-content-user-whatsup\" title=\"[个性签名] '+whatsup+'\">'+whatsup+'</span>'+
            '   </div>'+
            ...
            '</div>'+
            '<dl id=\"im-panel-main-rightdetail-content-editremark4friend-layout\" style="\"'+(isFriend?"":"display:none;")+'\">'+
            '   <dt>设置备注 <i id=\"im-panel-main-rightdetail-content-editremark4friend-btn\" class=\"icon-edit\"></i></dt>'+
            '   <dd><span class=\"label\">好友备注：</span><span id=\"im-panel-main-rightdetail-content-lb-remark4friend\" class=\"content content_autowrap\">'+""+'</span></dd>'+
            '   <dd><span class=\"label\">更多描述：</span><span id=\"im-panel-main-rightdetail-content-lb-moredesc4friend\" class=\"content\" style=\"display: inline;\">'+""+'</span></dd>'+
            '</dl>'+
            '</div>'+
            '<dl id=\"im-panel-main-rightdetail-content-editremark4friend-layout\" style="\"'+(isFriend?"":"display:none;")+'\">'+
            '   <dt>会员备注(群管共享) <i id=\"im-panel-main-rightdetail-content-editremark4friend-btn-2\" class=\"icon-edit\"></i></dt>'+
            '   <dd><span class=\"label\">备注信息：</span><span id=\"im-panel-main-rightdetail-content-lb-remark4friend-2\" class=\"content content_autowrap\">'+memberRemark+'</span></dd>'+
            '</dl>'+
            '<dl>'+
            '   <dt>基本信息</dt>'+
            '   <dd id=\"im-panel-main-rightdetail-content-user-originalname-layout\"><span class=\"label\">昵称：</span><span class=\"content\">'+nickname+'</span></dd>'+
            ...
            (isManager ?'   <dd><span class=\"label\">UED账号：</span><span class=\"content\" id=\'im-panel-main-rightdetail-content-eidtUED-content\'>'+(ree.uedUsername && ree.uedUsername.length > 0 ?ree.uedUsername: '无')+'</span><i id=\"im-panel-main-rightdetail-content-eidtUED-btn\" class=\"icon-edit\"/></dd>':"")+
            ...
            (isManager ?'   <dd><span class=\"label\">维护记录：</span><i id=\"im-panel-main-rightdetail-content-eidtwhued-btn\" class=\"icon-edit\"/></dd>':"")+
            (isManager ?'   <dd><span class=\"label\">召回记录：</span><i id=\"im-panel-main-rightdetail-content-eidtzhued-btn\" class=\"icon-edit\"/></dd>':"")+
            (isManager ?'   <dd><span class=\"label\">短信发送：</span><i id=\"im-panel-main-rightdetail-content-send-cmsmsg-btn\" class=\"icon-edit\"/></dd>':"")+
            ...
            '   <dd class=\"add-tag\">'+(isFriend?'<a class=\"btn btn-sm btn-red red btn-hollow\" id=\"im-panel-main-rightdetail-content-delfriend-btn\">删除好友</a>':'<a class=\"btn btn-sm btn-blue blue btn-hollow\" id=\"im-panel-main-rightdetail-content-addfriend-btn\">加为好友</a>')+'</dd>'+
            '</dl>'
        ;
        ...
        //维护记录
        $('#im-panel-main-rightdetail-content-eidtwhued-btn').click(function(){
             const tt = $('#im-panel-main-rightdetail-content-eidtUED-content').text();
             var name=''
             if(tt != '无'){
                name = tt;
             }
         ...
         //召回记录
         $('#im-panel-main-rightdetail-content-eidtzhued-btn').click(function(){
            const tt = $('#im-panel-main-rightdetail-content-eidtUED-content').text();
            if(tt != '无'){
        ...
        // 短信发送
        $('#im-panel-main-rightdetail-content-send-cmsmsg-btn').click(function(){
            RBChatDialogHelper.showSendMsgForm(uid);
        })


        if(isManager){
            $("#im-panel-main-rightdetail-content-eidtUED-btn").click(function () {
        ...
        if(isFriend){
            // 删除好友的事件处理
            $("#im-panel-main-rightdetail-content-delfriend-btn").click(function(){
                RBChatRosterUI.deleteWithConfirm(uid,nickname);
            });
        }
        else{
            // 添加好友的事件处理
            $("#im-panel-main-rightdetail-content-addfriend-btn").click(function(){
                RBChatDialogHelper.showSendAddFriendReqForm(uid, nickname);
            });
        }

        // 在对话框架中单独显示完整的个性签名内容
        $("#im-panel-main-rightdetail-content-user-whatsup").click(function(){
            RBChatDialogHelper.showAlertDialog_INFO("个性签名", whatsup);
        });

        if(isFriend) {
            // 设置备注功能的按钮事件处理
            $("#im-panel-main-rightdetail-content-editremark4friend-btn").click(function () {
                RBChatDialogHelper.showFriendRemarkEdit(ree)
            });

             // 设置备注功能的按钮事件处理
             $("#im-panel-main-rightdetail-content-editremark4friend-btn-2").click(function () {
    ...
    UIModule6.prototype.refreshFriendRemark = function(isFriend, friendInfo){
        ...
        var $layoutSetupRemark = $('#im-panel-main-rightdetail-content-editremark4friend-layout');
        var $layoytOriginalNickname = $('#im-panel-main-rightdetail-content-user-originalname-layout');
        var $viewNickname = $('#im-panel-main-rightdetail-content-user-showname');
        // var $viewOriginalNickname = $('#im-panel-main-rightdetail-content-user-originalname');
        var $viewRemark = $('#im-panel-main-rightdetail-content-lb-remark4friend');
        var $viewMobileNum = $('#im-panel-main-rightdetail-content-lb-mobilenum4friend');
        var $viewMoreDesc = $('#im-panel-main-rightdetail-content-lb-moredesc4friend');
     ...
     */
    UIModule6.prototype.showGroupBaseInfo = function(ge){
        ...
        var html =
            ...
            "		<img  onerror='javascript:groupTTnotFound($(this))' id=\'im-panel-main-rightdetail-content-group-avatar-"+gid+"\' src=\'"+RBChatUtils.getGroupAvatarDownloadURL(gid, false)+"\'>"+
            ...
            "<a class=\'btn btn-fb btn-sm btn-blue blue btn-hollow\' id=\'im-panel-main-rightdetail-bottom-viewmforbid-btn\'> 全员禁言<span id=\'im-panel-main-rightdetail-bottom-forbid_status\'>("+(ge.forbid_status - 0 == 1? '开':'关')+")</span></a>" +
        ...
        /** 查看/管理群成员的按钮事件处理 */
        $("#im-panel-main-rightdetail-bottom-viewmembers4group-btn").click(function(){
            RBChatDialogHelper.showViewOrMgrGroupMemberDialog(gid, localUserIsGroupOwner, ge.manage_mark - 0 == 1);
        });
        /** 邀请入群的按钮事件处理 */
        $("#im-panel-main-rightdetail-bottom-invitemember4group-btn").click(function(){
            RBChatDialogHelper.showInviteGroupMemberDialog(gid, localUserIsGroupOwner);
        });
        /** 全员禁言 */
        $('#im-panel-main-rightdetail-bottom-viewmforbid-btn').click(function(){
            RBChatRestHelper.submitForbidToServer(gid, forbid_status - 0 == 1 ? "0": "1"
                // 数据读取成功后的回调
        ...
        if(localUserIsGroupOwner){
            // 群主转让的按钮事件处理
            $("#im-panel-main-rightdetail-bottom-transfer4group-btn").click(function(){
                RBChatDialogHelper.showTrasferGroupDialog(gid, localUserIsGroupOwner);
            });

            // 解散群组功能的按钮事件处理
            $("#im-panel-main-rightdetail-bottom-dismiss4group-btn").click(function(){
                that.doDismissGroupToServer(gid, nickNameInGroup, localUserIsGroupOwner, localUserInfo);
            });

            // 修改群名称功能的按钮事件处理
            $("#im-panel-main-rightdetail-content-editgname-btn").click(function(){
        ...
        /** 其它按钮事件（本地用户不是此群的群主） */
            ...
            // 退出群聊功能的按钮事件处理
            $("#im-panel-main-rightdetail-bottom-quit4group-btn").click(function(){
        ...
        $("#im-panel-main-rightdetail-content-editnick4group-link").click(clickEditGrupInnerNickname);
        $("#im-panel-main-rightdetail-content-editnick4group-btn").click(clickEditGrupInnerNickname);

        /** 查看或编辑群公告的按钮事件处理 */
        var clickViewOrEditNotice = function(event){
            RBChatDialogHelper.showGroupNoticeEdit(ge);
        };
        $("#im-panel-main-rightdetail-content-viewnotice-btn").click(clickViewOrEditNotice);
        $("#im-panel-main-rightdetail-content-editnotice-btn").click(clickViewOrEditNotice);

        /** 查看群主个人信息的按钮事件处理 */
        $("#im-panel-main-rightdetail-content-viewowner4group-btn").click(function(event){
    ...
    UIModule6.prototype.initLocalAvatarFileUplodifive5 = function(gid,$destSendBtnObj, apid,adefaultip)
    {
        ...
        $destSendBtnObj.uploadifive({
            ...
            'onUploadComplete': function (file, data) {
                ...
                if(dom){
                    $('#'+apid).attr('src',RBChatUtils.getGroupAvatarDownloadURL(gid, true));
                }else{
                   
                    $('#'+adefaultip).after("<img  onerror='javascript:$(this).remove()' id=\'"+apid+"\' src=\'"+RBChatUtils.getGroupAvatarDownloadURL(gid, false)+"\'>")
                }
                // 更新列表里面的头像
     ...
     * 清空所有tabs。
     */
    UIModule6.prototype.clearTabs = function(){
        $('#im-panel-header-righttabs').empty();
    };

    /**
     * 清空内容区（中间）.
     */
    UIModule6.prototype.clearDetailContent = function(){
    ...
    UIModule6.prototype.setDetailContentEmpty = function(hintText, icon){
        var emptyHTML =
            ...
            "</div>";
        this.clearDetailContent();
        $('#im-panel-main-rightdetail-content').append(emptyHTML);
    };
    ...
    UIModule6.prototype.setBottom = function(bottomContentHtml){
        this.clearBottom();
        $('#im-panel-main-rightdetail-bottom').append(bottomContentHtml);
    };
    ...
    UIModule6.prototype.clearBottom = function(){
        $('#im-panel-main-rightdetail-bottom').empty();
    };
            ...
            , function (returnValue) {
                ...
                if(groupInfo){
                    ...
                    // 我在此群里
                        ...
                        // 在UI上显示查询到的群信息
                        that.showGroupBaseInfo(groupInfo);
    ...
    UIModule6.prototype.loadSingleUserBaseInfoFromServer = function(uid){
        ...
        RBChatRestHelper.submitGetUserInfoToServer(false, null, uid
            ...
            , function (returnValue) {
                ...
                if(ree){
                    that.showSingerUserBaseInfo(ree);
                }
                else {
