 ...
 * ======================================================================
 * 【基本说明】：
 * 本文件是MobileIMSDK-Web版SDK工程中自带的测试Demo主文件。
 *
 * 【重要说明】：
 * 本文件不属于MobileIMSDK-Web版SDK的核心代码，仅仅是为了方便随时随地测试SDK代码
 * 而存在，开发者可以参考本文件实现自已的IM服务端主入口代码。将MobileIMSDK-Web版
 * SDK引入到开发者的其它工程中时，本文件是不需要的。
 * ======================================================================
 */
