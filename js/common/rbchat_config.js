...
(function () {
   ...
   // var _HTTP_SERVER_ROOT_URL = "https://"+document.domain;
    var _HTTP_SERVER_ROOT_URL = "https://testchat.imnono.net"; // test

    /* 实时通信websocket服务器地址 */
   // var _IM_SERVER_URL = "https://"+document.domain;                        // TODO: 【2】开发者请修改为您自已的 web im 服务端地址（即nodejs服务地址）
     var _IM_SERVER_URL = "https://testchat.imnono.net"; // test 

    var _COUPON_IFRAME_URL =  window.location.hostname.includes('test') ? 'https://testchat.imnono.net' : 'https://chat.imnono.net'
    // var _COUPON_IFRAME_URL = 'https://testchat.imnono.net';
    var _H5_DOMAIN1 = window.location.hostname.includes('test') ? 'testh5.imnono.net' : 'h5.imnono.net'
    var _H5_DOMAIN2 = window.location.hostname.includes('test') ? 'testh5.imnono.net' : 'h5.nongzhiw.cn'

    // 文件地址
    var  _FILE_HTTPS_URL = ''; // 'https://oss.nongzhiw.cn'
    var _FEEDBACK_LINK = "https://reply.yun-neng.com/feedback.html";
    // var _FEEDBACK_LINK = "http://"+ "localhost:3000" + '/feedback';
    ...
    var config = {
        ...
        COUPON_IFRAME_URL                              : _COUPON_IFRAME_URL,
        H5_DOMAIN1                                     : _H5_DOMAIN1,
        H5_DOMAIN2                                     : _H5_DOMAIN2,
